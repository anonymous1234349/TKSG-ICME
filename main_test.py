...
def parse_agrs():
    ...
    parser.add_argument('--concept_topk', type=int, default=40, help='Concept Topk')
    ...
    parser.add_argument('--clip', type=str, default='ViT-B/16', help='clip frame')  # ViT-B/16/32
    parser.add_argument('--model_frame', type=str, default='finetune_clip',
                        choices=['ResNet', 'clip_feat', 'finetune_clip', 'swin_transformer_base',
                                 'swin_transformer_tiny', 'swin_transformer_small', 'ViT'])  # clip_feat/finetune_clip
    ...
    parser.add_argument('--vocab_path', type=str, default='/data/',
                        help='vocab path.')  
    parser.add_argument('--segment', action='store_true', help='disease topic')
    ...
    parser.add_argument('--lr_ve', type=float, default=2e-4, help='the learning rate for the visual extractor.')
