...
class CaptionModel(nn.Module):
    ...
    def beam_search(self, init_state, init_logprobs, global_guide=None, local_guide=None, topic=None, *args, **kwargs):
            ...
            for divm in range(group_size):
                if t >= divm and t <= self.max_seq_length + divm - 1:
                    ...
                    logprobs_table[divm], state_table[divm] = self.get_logprobs_state(it, *(
                            args[divm] + [state_table[divm]]), global_guide=global_guide, local_guide=local_guide, topic=topic)
